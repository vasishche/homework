...
awk '/'^[1-9]+\.[1-9]+\.[1-9]+\.[1-9]+'/{if (ipnum[$1]++==0) ipmask[$1]="ip"++ctr; $1=ipmask[$1]; print $0}; END{for (i in ipmask) print ipmask[i]" - "i > "mask.txt"}' access.log > access.log.tmp && mv access.log.tmp access.log
